...
class Dsound
{
	...
	**/
	...
	/**
	   Declare Sound Volumes from an object {  "soundName" : Volume , "sound2" : Volume ... }
	   - Example: you can declare the sounds in a json file :
			"soundFiles" : {
				"pl_slide" : 0.4 ,
				"pl_jump"  : 0.5
			}
	   - And then you can parse the JSON file and push to here:
			D.snd.addMetadataNode(Json.parse("FILE.JSON").soundFiles);
	**/
	public function addSoundInfos(node:Dynamic)
	{
		...
		// trace("Parsing sound infos",Reflect.fields(node));
